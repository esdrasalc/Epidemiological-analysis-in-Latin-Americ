...
initial_state_values <- c(S = 127000000-1,   # the whole population we are modelling is susceptible to infection
...
times <- seq(from = 0, to = 677, by = 1)   # from 0 to 100 days in daily intervals
